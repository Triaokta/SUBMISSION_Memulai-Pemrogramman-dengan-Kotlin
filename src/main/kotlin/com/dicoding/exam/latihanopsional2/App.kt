...
fun minAndMax(number: Int): Int {
    val numb = number.toString().map { it.toString().toInt() }
    val minNumb = numb.minOrNull() ?: 0
    val maxNumb = numb.maxOrNull() ?: 0
    println("Angka terkecil= $minNumb, angka terbesar=$maxNumb -> $minNumb+$maxNumb -> ${minNumb + maxNumb}")
